# Pulse Slab Flutter telemetry demo

This source-only Flutter application simulates 24 telemetry records at a
configurable rate of 200 to 1,000,000 updates per second. It is an integration
and performance test bed for the `pulse_slab_flutter` adapter, not a pub.dev
developer template or production dashboard.
